...
// Barra superior móvil del sistema Sierra: 56px sobre papel casi opaco (sin
// desenfoque: en móvil el blur sobre contenido que scrollea da tirones), con
...
function MobileHeader({ onAbrirMenu }) {
  return (
    <header
      data-no-print
      className="fixed inset-x-0 top-0 z-30 flex h-barra-movil items-center gap-1 bg-papel/95 pl-1.5 pr-4 shadow-barra-movil md:hidden"
    >
      <button
      ...
      <div className="flex min-w-0 flex-1 items-center gap-2.5">
        <img src="/logo-legumex-icon.png" alt="Legumex" className="block h-7 w-auto shrink-0" />
