...
const botonFuturo =
  'inline-flex h-10 shrink-0 items-center justify-center gap-2 whitespace-nowrap rounded-boton border border-outline-variant bg-white px-3 sm:px-4 font-body-md text-body-md font-medium text-on-surface-variant opacity-50 cursor-not-allowed'
      ...
      <div className="animate-view-in flex-1 px-4 pt-6 pb-10 md:px-8 md:pt-10">
        <div className="max-w-[1200px] mx-auto flex flex-col gap-stack-lg">
          ...
          {/* Tabla + paginador en una sola tarjeta en escritorio (el paginador
              queda de pie de tabla, mismo patrón que Historial); en móvil el
              envoltorio no dibuja nada y las tarjetas siguen sueltas. */}
              ...
              visibles.map((registro) => (
                ...
                >
                  <div className="min-w-0">
                    ...
                    <p className="mt-0.5 font-mono text-micro uppercase tracking-[0.1em] text-on-surface-variant tabular-nums">
                      ID {registro.id}
                    </p>
                  </div>
                </button>
